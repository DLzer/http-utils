...
namespace Dlzer\Http\Message;

interface StatusMessageInterface
{
    // Informational 1xx
    const STATUS_CONTINUE = "Continue";
    const STATUS_SWITCHING_PROTOCOLS = "Switching Protocol";
    const STATUS_PROCESSING = "Processing";
    const STATUS_EARLY_HINTS = "Early Hints";
    // Successful 2xx
    const STATUS_OK = "OK";
    ...
    // Redirection 3xx
    const STATUS_MULTIPLE_CHOICES = "Multiple Choice";
    ...
    const STATUS_TOO_EARLY = "Too Early";
